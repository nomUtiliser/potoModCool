package net.nomUtiliser.potoModCool.tabs;
...
import net.nomUtiliser.potoModCool.tabs.all.YourTabClass;

public class Tabs {
    private static final RegistryList<Tab> LIST = new RegistryList<>();

    // example tab
    public static final SmartSupplier<Tab> MY_TAB = LIST.add(() -> new Tab(new ResourceLocation(potoflexMod.MOD_ID, "your_tab_id"), YourTabClass.class));
